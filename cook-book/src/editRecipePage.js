...
//             <br/>
//             <input type = "text" onChange={(e)=>{setCuisine(e.target.value)}} required placeholder="Cuisine" value={cuisine}/>
//             <br/>
...
//                     return(
//                         <Ingredient key={val.ingredientId} item = {val} index = {index} setIngredients = {setIngredients} setDeletedIngredients = {setDeletedIngredients} viewOnly = {false}/>
//                     )
//                 })}
